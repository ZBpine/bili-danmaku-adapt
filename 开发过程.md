...
### `GM_xmlhttpRequest`奇怪的bug

使用`GM_xmlhttpRequest`后大约10秒后会卡住UI大约7~8秒，故`1.2.0`改回`fetch`

`2026.05`
原因找到了：[篡改猴bug，已于`5.5.0`修复](https://www.tampermonkey.net/changelog.php?version=5.5.0)